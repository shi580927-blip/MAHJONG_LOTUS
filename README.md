...
Проект игры **«Маджонг: Путь Лотоса»**.
...
Разработка не начинается автоматически. Работа ведётся строго по цикличному регламенту и текущему состоянию в `PROJECT_STATE.md`.
